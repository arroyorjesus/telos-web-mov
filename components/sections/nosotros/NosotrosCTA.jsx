...
export default function NosotrosCTA() {
  return (
    <section className="final-cta-section cta-blue" id="nosotros-cta" aria-labelledby="nosotros-cta-heading">
      <div className="final-cta-inner">
        ...
        <h2 id="nosotros-cta-heading" className="final-cta-h2 reveal-heading" style={{ '--i': 1 }}>
          ¿Tu operación está trabajando<br/>a su <em>capacidad real de OPEX?</em>
        </h2>
