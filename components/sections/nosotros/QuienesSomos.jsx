...
const CARDS = [
  ...
  {
    index: '03',
    title: 'Infraestructura energética para plantas de nearshoring',
    description:
      'Empresas internacionales que establecen operaciones en México enfrentan infraestructura energética envejecida y tarifas industriales complejas.\n\nDiseñamos e implementamos la infraestructura de agua, gas y electricidad que sus plantas necesitan para operar con eficiencia desde el primer día.',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
