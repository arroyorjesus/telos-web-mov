...
export default function UstedesCTA() {
  return (
    <section className="final-cta-section cta-blue" id="ustedes-cta" aria-labelledby="ustedes-cta-heading">
      <div className="final-cta-inner">
        ...
        <h2 id="ustedes-cta-heading" className="final-cta-h2 reveal-heading" style={{ '--i': 1 }}>
          La siguiente operación<br/>debería ser <em>la tuya.</em>
        </h2>

        <p className="final-cta-sub reveal" style={{ '--i': 2 }}>
          Si tu operación consume agua, gas o electricidad todos los días,
          ya hay OPEX que puede recuperarse. Hacemos el diagnóstico, tú decides.
        </p>
