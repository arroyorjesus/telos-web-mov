...
const TRUST = [
  '150+ proyectos de infraestructura',
...
const CheckCircle = () => (
  <svg className="final-cta-trust-check" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default function HomeCTA() {
  return (
    <section className="final-cta-section" id="cta-final" aria-labelledby="cta-final-heading">
      <div className="final-cta-inner">

        <Reveal style={{ '--i': 0 }}>
          <span className="final-cta-badge">
            <span className="final-cta-badge-dot"></span>
            Análisis estratégico · Sin compromiso inicial
          </span>
        </Reveal>

        <h2 id="cta-final-heading" className="final-cta-h2 reveal-heading" style={{ '--i': 1 }}>
          ¿Tu operación está trabajando<br/>a su <em>capacidad real?</em>
        </h2>

        <p className="final-cta-sub reveal" style={{ '--i': 2 }}>
          Hacemos el diagnóstico.<br/>Tú decides si tiene sentido continuar.
        </p>

        <Reveal className="final-cta-buttons reveal" style={{ '--i': 3 }}>
        ...
        <Reveal className="final-cta-trust reveal" style={{ '--i': 5 }}>
          {TRUST.map((t) => (
