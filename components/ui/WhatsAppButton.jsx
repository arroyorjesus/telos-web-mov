...
export default function WhatsAppButton({
  ...
  const base = variant === 'minimal'
    ? 'inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors'
    : 'inline-flex items-center gap-2.5 px-5 py-3 rounded-xl bg-slate-100 border border-slate-200 text-slate-900 font-medium text-sm hover:bg-slate-200 hover:border-slate-300 transition-all duration-200'
